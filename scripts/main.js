...
function enterKey(e) {
    ...
    if (e.keyCode == 13) {
        ...
        git = commands.length;
        addLine("lucas'Portfolio:~$ " + command.innerHTML, "no-animation", 0);
...
function router(cmd){
    switch (cmd.toLowerCase()) {
        ...
        case "email":
            addLine('Opening mailto:<a href="mailto:lucasrespick@gmail.com">lucasrespick@gmail.com</a>...', "color2", 80);
            openNewTab(email);
            break;
